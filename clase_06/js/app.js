...
function imprimirFilas()
    ...
    datos.forEach((item, i) => {
      salida=salida+"<tr><td>Alumno "+i+"</td><tr><td>Apellido: "+item[0]+"</td></tr><tr><td>Nombre: "+item[1]+"</td></tr><tr><td>Fecha de Nacimiento: "+item[2]+"</td></tr><tr><td><td><button type='button' class='btEditar  btn btn-warning' data-id='"+i+"'>Editar</button></td></td><td><button type='button' class='btBorrar btn btn-danger' data-id='"+i+"'>Borrar</button> </td></tr>"
    });
